...
<section class="govuk-grid-column-full govuk-!-margin-top-5">
<p class="govuk-body govuk-!-font-weight-regular">This glossary provides a list of commonly used HMLR terms and their definitions. This will help you to understand how they relate to terms used in the business, and in the relevant legislation.</p>
</section>

<section class="govuk-grid-column-full govuk-!-margin-top-5" id="A">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="B">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="C">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="E">
  <h2 class="govuk-heading-m">E</h2>
  <h3 class="govuk-heading-s">Electronic Document Registration Service (e-DRS)</h3>
  <p class="govuk-body">A group of services that allow users to submit electronic applications to change the register, along with supporting documents.</p>
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="F">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="H">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="I">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="J">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="L">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="M">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="O">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="P">
  <h2 class="govuk-heading-m">P</h2>
  <h3 class="govuk-heading-s">Proprietor</h3>
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="R">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="S">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="U">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="V">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="W">
...
<section class="govuk-grid-column-full govuk-!-margin-top-5" id="X">
