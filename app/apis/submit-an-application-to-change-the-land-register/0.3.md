            ...
            <ol class="app-step-nav__list " data-length="3">
              ...
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="4.2" class="app-step-nav__link js-link"
                  href="/apis/notifications-technical-guide/0.3/">Technical Guide </a>
              </li>
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="4.3" class="app-step-nav__link js-link" href="/apis/notifications-test-stubs/0.3/">Test
                  stubs </a>
              </li>
            </ol>
          </div>
