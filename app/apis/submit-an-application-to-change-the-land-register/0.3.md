      ...
      <ol class="app-step-nav__steps">
          ...
          <div class="app-step-nav__panel js-panel" id="send-a-document-api">
            <ol class="app-step-nav__list " data-length="3">
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="1.1" class="app-step-nav__link js-link" href="/apis/send-a-document">Overview </a>
              </li>
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="1.2" class="app-step-nav__link js-link"
                  href="/apis/send-a-document-technical-guide">Technical Guide </a>
              </li>
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="1.3" class="app-step-nav__link js-link" href="/apis/send-a-document-test-stubs">Test
                  stubs </a>
              </li>
            </ol>
          </div>
            ...
            <ol class="app-step-nav__list " data-length="3">
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="2.1" class="app-step-nav__link js-link"
                  href="/apis/submit-an-application">Overview</a>
              </li>
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="2.2" class="app-step-nav__link js-link"
                  href="/apis/submit-an-application-technical-guide">Technical Guide </a>
              </li>
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="2.3" class="app-step-nav__link js-link"
                  href="/apis/submit-an-application-test-stubs">Test stubs </a>
              </li>
            </ol>
          </div>
        </li>
            ...
            <ol class="app-step-nav__list " data-length="3">
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="3.1" class="app-step-nav__link js-link"
                  href="/apis/application-information">Overview</a>
              </li>
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="3.2" class="app-step-nav__link js-link"
                  href="/apis/application-information-technical-guide">Technical Guide </a>
              </li>
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="3.3" class="app-step-nav__link js-link"
                  href="/apis/application-information-test-stubs">Test stubs </a>
              </li>
            </ol>
          </div>
        </li>
        <li class="app-step-nav__step js-step" id="notifications-api">
          ...
          <div class="app-step-nav__panel js-panel" id="step-panel-notifications-api">
            <ol class="app-step-nav__list " data-length="3">
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="4.1" class="app-step-nav__link js-link" href="/apis/notifications">Overview</a>
              </li>
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="4.2" class="app-step-nav__link js-link"
                  href="/apis/notifications-technical-guide">Technical Guide </a>
              </li>
              <li class="app-step-nav__list-item js-list-item ">
                <a data-position="4.3" class="app-step-nav__link js-link" href="/apis/notifications-test-stubs">Test
                  stubs </a>
              </li>
            </ol>
          </div>
