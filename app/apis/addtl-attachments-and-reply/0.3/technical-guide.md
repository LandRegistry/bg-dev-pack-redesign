...
title: Additional attachments and reply API Technical guide
description: Use this service to get information about a specific application.

notlive: true

eleventyNavigation:
  key: Additional attachments and reply API v0.3 Technical guide
  parent: Additional attachments and reply API v0.3

sidenav:
  - theme: Contents
    text: 'How to use the Additional attachments and reply API'
    href: '#how-to-use-the-addtl-attachments-and-reply-api'
  - theme: Contents
...
<h2 class="govuk-heading-m" id="how-to-use-the-addtl-attachments-and-reply-api">How to use the Download a document API</h2>
