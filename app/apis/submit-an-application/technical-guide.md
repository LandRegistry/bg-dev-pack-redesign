  ...
  <div class="govuk-grid-column-two-thirds govuk-prototype-kit-common-templates-mainstream-guide-body">
    ...
    <div>
      <p class="govuk-body">To submit an application request, make an HTTP POST request to the application request
        endpoint, the body of which contains the information about the application using the <code
          style="color: #a71d5d; background-color: #f5f5f5">application/json</code> content type.</p>
    ...
    <div>
      ...
      <div>
        ...
        <details class="govuk-details">
          ...
          <div class="govuk-details__text">
            <table class="govuk-table">
              ...
              <tr class="govuk-table__row">
                <td class="govuk-table__cell govuk-table__cell">VAR_CHARGE</td>
                <td class="govuk-table__cell govuk-table__cell">Deed of Variation of Charge</td>
              </tr>
              <tr class="govuk-table__row">
                <td class="govuk-table__cell govuk-table__cell">VAR_COV</td>
                <td class="govuk-table__cell govuk-table__cell">Deed of Variation of Covenants</td>
              </tr>
              <tr class="govuk-table__row">
                <td class="govuk-table__cell govuk-table__cell">VAR_EAS</td>
                <td class="govuk-table__cell govuk-table__cell">Deed of Variation of Easements</td>
              </tr>
              <tr class="govuk-table__row">
                <td class="govuk-table__cell govuk-table__cell">VAR_LEASE</td>
                <td class="govuk-table__cell govuk-table__cell">Deed of Variation of Lease</td>
              </tr>
              <tr class="govuk-table__row">
                <td class="govuk-table__cell govuk-table__cell">VESTING_ORDER</td>
                <td class="govuk-table__cell govuk-table__cell">Vesting order</td>
              </tr>
              <tr class="govuk-table__row">
                <td class="govuk-table__cell govuk-table__cell">WCT</td>
                <td class="govuk-table__cell govuk-table__cell">WCT Withdraw caution</td>
              </tr>
              <tr class="govuk-table__row">
                <td class="govuk-table__cell govuk-table__cell">WINDING_UP</td>
                <td class="govuk-table__cell govuk-table__cell">Winding up order</td>
              </tr>
              <tr class="govuk-table__row">
                <td class="govuk-table__cell govuk-table__cell">WIT_STATE</td>
                <td class="govuk-table__cell govuk-table__cell">Witness Statement</td>
              </tr>
              </tbody>
            </table>
          </div>
        </details>
        <p class="govuk-body">As well as the definition of each transaction/document, we have also provided a mapping,
          showing the required documents for each transaction type. There are three categories of documents that can be
          uploaded for a transaction:</p>
        <ul class="govuk-list govuk-list--bullet">
          <li><b>Compulsory</b> - this document is required for the transaction type</li>
          <li><b>Either</b> - at least one of the documents marked as Either must be submitted with the transaction</li>
          <li><b>Suggested</b> - these documents are not required, but are commonly attached alongside the transaction
          </li>
        </ul>
        <p class="govuk-body">For example, for an <code style="color: #a71d5d; background-color: #f5f5f5">ADV1</code>
          transaction type, the following documents need to be uploaded:</p>
        <ul class="govuk-list govuk-list--bullet">
          <li>An <code style="color: #a71d5d; background-color: #f5f5f5">ADV1</code> document must be uploaded </li>
          <li>At least one of an <code style="color: #a71d5d; background-color: #f5f5f5">SOT</code> or <code
              style="color: #a71d5d; background-color: #f5f5f5">STAT_DEC</code> document must be uploaded</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">COSR</code>, <code
              style="color: #a71d5d; background-color: #f5f5f5">EVIDENCE</code>, <code
              style="color: #a71d5d; background-color: #f5f5f5">PLAN</code> and <code
              style="color: #a71d5d; background-color: #f5f5f5">POA</code> documents are not required, but may help when
            processing your application</p>
        </ul>
        <p class="govuk-body">During application submission, validation will be applied for each transaction to ensure
          the rules regarding the Compulsory and Either document types have been satisfied correctly:</p>
        <details class="govuk-details">
          <summary class="govuk-details__summary">
            <span class="govuk-details__summary-text">
          ...
          <div class="govuk-details__text">
            <table class="govuk-table">
              <caption class="govuk-table__caption govuk-table__caption--m">Transaction/document mapping</caption>
              <thead class="govuk-table__head">
                <tr class="govuk-table__row">
                  <th scope="col" class="govuk-table__header">Transaction type code</th>
                  <th scope="col" class="govuk-table__header">Document type code</th>
                  <th scope="col" class="govuk-table__header">Document class code</th>
                </tr>
              </thead>
              <tbody class="govuk-table__body">
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">ADV1</td>
                  <td class="govuk-table__cell">ADV1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">SOT</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">STAT_DEC</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">COSR</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">PLAN</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">POA</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">ADV2</td>
                  <td class="govuk-table__cell">ADV2</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">AGN</td>
                  <td class="govuk-table__cell">AN1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CHARGE</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CHARG_ORD</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CONSENT</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CONV_CERT</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">COURT_ORD</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">TRANSFER</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">DEED</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">APLC</td>
                  <td class="govuk-table__cell">CRWALIQ</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">FORM_600</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">FORM_600CH</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CRED_DEC</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CRED_RES</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">LIQ_CERT_2</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">LIQ_CERT_3</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">APLCO</td>
                  <td class="govuk-table__cell">WINDING_UP</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CONTR_RES</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">LIQ_CERT_1</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">SSALIQ</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">APLM</td>
                  <td class="govuk-table__cell">CERT_S89</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">LIQ01</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CRALIQ</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">APR</td>
                  <td class="govuk-table__cell">DEED</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">MORD</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">APT</td>
                  <td class="govuk-table__cell">TRANSFER</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">TRUSTEE_RESOLUTION</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">VESTING_ORDER</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">APPOINTMENT_OF_TRUSTEE</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">ASSTTP</td>
                  <td class="govuk-table__cell">AS3</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">ADMIN_LTRS</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">DEATH_CERT</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">ASTC</td>
                  <td class="govuk-table__cell">AS2</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">ASTT</td>
                  <td class="govuk-table__cell">AS1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">ATP</td>
                  <td class="govuk-table__cell">CORRES</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">AUN</td>
                  <td class="govuk-table__cell">UN3</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">BKN</td>
                  <td class="govuk-table__cell">K3</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">K4</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">BKR</td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">Compulsory</td>
                  <td class="govuk-table__cell">CH1</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">MRTG_DEED</td>
                  <td class="govuk-table__cell">Either (Compulsory if mdref is provided)</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CAG</td>
                  <td class="govuk-table__cell">CN1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CANI</td>
                  <td class="govuk-table__cell">RX3</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CANR</td>
                  <td class="govuk-table__cell">RX3</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CANU</td>
                  <td class="govuk-table__cell">UN4</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CBKN</td>
                  <td class="govuk-table__cell">COURT_ORD</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">K22</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">ADJAR</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">ACKAPU</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">ADJREVU</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">K20</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CBKR</td>
                  <td class="govuk-table__cell">COURT_ORD</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CCT</td>
                  <td class="govuk-table__cell">CCD</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CH3</td>
                  <td class="govuk-table__cell">CH3</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CHOA</td>
                  <td class="govuk-table__cell">AN1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CHOU</td>
                  <td class="govuk-table__cell">UN1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CHR</td>
                  <td class="govuk-table__cell">HR4</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">BIRTH_CERT</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">DEED_POLL</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">DRIVING_LICENCE</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">GENDER_CERT</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CIVIL_CERT</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CNC</td>
                  <td class="govuk-table__cell">CORRES</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CNL</td>
                  <td class="govuk-table__cell">CN1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">COA</td>
                  <td class="govuk-table__cell">CORRES</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">COAC</td>
                  <td class="govuk-table__cell">CORRES</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CON</td>
                  <td class="govuk-table__cell">CC</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">COP</td>
                  <td class="govuk-table__cell">CH1</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CPD</td>
                  <td class="govuk-table__cell">CORRES</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CPVK</td>
                  <td class="govuk-table__cell">DEED_POLL</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">GVD</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CPVU</td>
                  <td class="govuk-table__cell">DEED_POLL</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CTD</td>
                  <td class="govuk-table__cell">CM2</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">CUR</td>
                  <td class="govuk-table__cell">CN1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DB</td>
                  <td class="govuk-table__cell">BOUND_PLAN</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DCLN</td>
                  <td class="govuk-table__cell">EVIDENCE</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DCLV</td>
                  <td class="govuk-table__cell">EVIDENCE</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DFL1</td>
                  <td class="govuk-table__cell">LEASE</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">SDLT</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">LTT</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">COMP_DOC</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DFL3</td>
                  <td class="govuk-table__cell">LEASE</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DFL4</td>
                  <td class="govuk-table__cell">LEASE</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DFL5</td>
                  <td class="govuk-table__cell">LEASE</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">VAR_LEASE</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">FORM_JO</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DFT</td>
                  <td class="govuk-table__cell">EVIDENCE</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DIS</td>
                  <td class="govuk-table__cell">DS1</td>
                  <td class="govuk-table__cell">Compulsory (When <code>discharge_submission_type</code> is
                    <code>ATTACHED</code>)</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DJP</td>
                  <td class="govuk-table__cell">DJP</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CERT_DEATH</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">COR_CERT</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DL</td>
                  <td class="govuk-table__cell">LEASE</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DMR</td>
                  <td class="govuk-table__cell">RX2</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DOG</td>
                  <td class="govuk-table__cell">DEED</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DP</td>
                  <td class="govuk-table__cell">DS1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DSP</td>
                  <td class="govuk-table__cell">DEATH_CERT</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">DTL</td>
                  <td class="govuk-table__cell">LEASE</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">EXR</td>
                  <td class="govuk-table__cell">CN1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  ...
                  <td class="govuk-table__cell">HR1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">JP1</td>
                  <td class="govuk-table__cell">JP1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCATCO</td>
                  <td class="govuk-table__cell">COURT_ORD</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">SHRF_RTN</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCBD</td>
                  <td class="govuk-table__cell">NOD</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">EOB</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">EOL</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">DS3</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">RX4</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">UN2</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCBET</td>
                  <td class="govuk-table__cell">CNFRM_DTMN_LTA_LGHA</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CNFRM_NO_LTA_LGHA</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">EVD_NO_RENEW</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCBN</td>
                  <td class="govuk-table__cell">RN</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCF</td>
                  <td class="govuk-table__cell">COURT_ORD</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CNSNT_ADMIN_COURT</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCMRE</td>
                  <td class="govuk-table__cell">CN1</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCOE</td>
                  <td class="govuk-table__cell">FR1</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">DEED_REG_DIS</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCOF</td>
                  <td class="govuk-table__cell">EVIDENCE</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCSD</td>
                  <td class="govuk-table__cell">DEED_SUR</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">TR1</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">TP1</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">LNDLD_CNSNT</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCSDM</td>
                  <td class="govuk-table__cell">DEED_SUR</td>
                  <td class="govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCSDMWT</td>
                  <td class="govuk-table__cell">DEED_SUR</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCSDWT</td>
                  <td class="govuk-table__cell">DEED_SUR</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCSOL</td>
                  <td class="govuk-table__cell">CN1</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell"></td>
                  <td class="govuk-table__cell">CNFRM_NO_DEED_SUR</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">LCSOLM</td>
                  <td class="govuk-table__cell">STAT_DEC</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">MDR</td>
                  <td class="govuk-table__cell">RX2</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">NCT</td>
                  <td class="govuk-table__cell">EVIDENCE</td>
                  <td class="govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell">NDC</td>
                  <td class="govuk-table__cell">CORRES</td>
                  <td class="govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell govuk-table__cell"></td>
                  <td class="govuk-table__cell govuk-table__cell">POA</td>
                  <td class="govuk-table__cell govuk-table__cell">Suggested</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell govuk-table__cell">NFR</td>
                  <td class="govuk-table__cell govuk-table__cell">AN1</td>
                  <td class="govuk-table__cell govuk-table__cell">Either</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell govuk-table__cell"></td>
                  <td class="govuk-table__cell govuk-table__cell">UN1</td>
                ...
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell govuk-table__cell">NOE</td>
                  <td class="govuk-table__cell govuk-table__cell">DEED</td>
                  <td class="govuk-table__cell govuk-table__cell">Compulsory</td>
                </tr>
                <tr class="govuk-table__row">
                  <td class="govuk-table__cell govuk-table__cell"></td>
                  <td class="govuk-table__cell govuk-table__cell">CONV_CERT</td>
        ...
        <p class="govuk-body">For each application type (<code
            style="color: #a71d5d; background-color: #f5f5f5">REGISTER_UPDATE</code>, <code
            style="color: #a71d5d; background-color: #f5f5f5">DISPOSITIONARY_FIRST_LEASE</code>, <code
            style="color: #a71d5d; background-color: #f5f5f5">TRANSFER_OF_PART</code> and <code
            style="color: #a71d5d; background-color: #f5f5f5">REMOVE_JP1</code>), only certain transaction types can be
          supplied. The sections below detail which transaction types are valid for each application type.</p>
        <details class="govuk-details">
          <summary class="govuk-details__summary">
            <span class="govuk-details__summary-text">
          ...
          <div class="govuk-details__text">
            ...
            <ul class="govuk-list govuk-list--bullet">
              <li><code style="color: #a71d5d; background-color: #f5f5f5">ADV1</code> - First notice of adverse
                possession</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">ADV2</code> - Adverse possession: notification
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">AGN</code> - Agreed notice (AN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">APLC</code> - Appointment of liquidator
                (creditor’s voluntary winding up)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">APLCO</code> - Appointment of liquidator
                (compulsory winding up)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">APLM</code> - Appointment of liquidator
                (members’ voluntary winding up)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">APR</code> - Apportionment of rent</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">APT</code> - Appointment of new trustee</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">ASTC</code> - Assent of charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">ATP</code> - Amendment to title plan</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">AUN</code> - Amendment of unilateral notice
                (UN3)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">BKN</code> - Bankruptcy notice/Creditors’
                notice</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">BKR</code> - Bankruptcy restriction/Bankruptcy
                inhibition</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">C</code> - Charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CAG</code> - Cancellation of notice (not
                unilateral) (CN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CANI</code> - Cancellation of inhibition (RX3)
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CANR</code> - Cancellation of restriction
                (RX3)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CANU</code> - Cancellation of unilateral
                notice (UN4)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CBKN</code> - Cancellation of bankruptcy
                notice</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CBKR</code> - Cancellation of bankruptcy
                restriction</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CCT</code> - Cancellation of a caution (CCD)
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CH2</code> - Obligation to make further
                advances (CH2)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CH3</code> - Agreed maximum amount of security
                (CH3)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CHOA</code> - Charging order - Agreed notice
                (AN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CHOU</code> - Charging order - Unilateral
                notice (UN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CHR</code> - Cancellation of home rights (HR4)
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CN</code> - Change of name</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CNC</code> - Change of name - chargee</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CNL</code> - Cancellation of an unregistered
                noted lease (CN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">COA</code> - Change of address for service
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">COAC</code> - Change of address for service -
                chargee</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CON</code> - Consolidation of charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">COP</code> - Charge of part</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CPD</code> - Change of property description
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CPVK</code> - Compulsory purchase (property
                value known)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CTD</code> - Commonhold transitional dealing
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CUR</code> - Cancellation of notice of
                unregistered Rentcharge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DB</code> - Determined boundary (DB)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DCLN</code> - Disclaimer - notification</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DCLV</code> - Disclaimer - notice</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DFL1</code> - New lease - other</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DFT</code> - Defect in title s64(1) LRA 2002
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DIS</code> - Discharge of charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DJP</code> - Death of a joint proprietor</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DL</code> - Discontinuous lease -
                non-timeshare</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DMR</code> - Disapplication of restriction
                (RX2)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DOG</code> - Deed of grant of easement</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DP</code> - Discharge of part</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DSP</code> - Death of a sole proprietor</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">JP1</code> - Removal of default Form A
                restriction</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCATCO</code> - Lease closure - of assured
                tenancies following court order</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCBD</code> - Lease closure - by disclaimer
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCBET</code> - Lease closure - by effluxion of
                time</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCBN</code> - Lease closure - by notice</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCF</code> - Lease closure - forfeiture</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCMRE</code> - Lease closure - merger with
                reversionary estate</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCOE</code> - Lease closure - on enlargement
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCOF</code> - Lease closure - on frustration
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSD</code> - Lease closure - surrender by
                deed (not for value or reverse premium)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSDM</code> - Lease closure - surrender by
                deed</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSDMWT</code> - Lease closure - surrender by
                deed (together with transfer)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSDWT</code> - Lease closure - surrender by
                deed with a transfer (not for value or reverse premium)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSOL</code> - Lease closure - surrender by
                operation of law (not for value or reverse premium)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSOLM</code> - Lease closure - surrender by
                operation of law</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">MDR</code> - Modification of Restriction</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">NCT</code> - Caution amendment</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">NDC</code> - Notification of dissolution of
                company</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">NFR</code> - Noting of an affecting franchise
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">NOE</code> - Noting an easement</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">NOL</code> - Noting a lease</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">NPR</code> - Noting of a profit</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">NRT</code> - Notice of rentcharge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">PC</code> - Postponement of charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">PRO</code> - Provisions</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">RC</code> - Restrictive covenants - entry of
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">RFN</code> - Deed of rectification</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">RHR</code> - Renewal of home rights (HR2)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">RNT</code> - Overriding lease granted under
                s.19</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">ROCA</code> - Release of covenants - agreed
                notice (AN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">ROCC</code> - Release of covenants -
                cancellation (CN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">ROCU</code> - Release of covenants -
                unilateral notice (UN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">ROE</code> - Release of easements</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">RRD</code> - Removal of a right to determine
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">RTM</code> - Acquisition of right to manage
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">RUN</code> - Removal of unilateral notice
                (UN2)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">RXL</code> - Form || restriction entered -
                simple request</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">RXN</code> - Restriction (non-standard
                wording) (RX1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">RXS</code> - Restriction (standard wording)
                (RX1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">SBC</code> - Sub charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">SHO</code> - Shared ownership - additional
                share</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">SJT</code> - Severance of joint tenancy (SEV)
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">STVC</code> - Statutory vestings charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">STVL</code> - Statutory vestings land</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">T</code> - Transfer for value</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TNV</code> - Transfer (not for value or
                reverse premium)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TOC</code> - Transfer of charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TOSNV</code> - Transfer of share (not for
                value or reverse premium)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TOSV</code> - Transfer of share for value</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TPS</code> - Transfer under power of sale</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TRC</code> - Termination of commonhold</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TRM</code> - Transfer by operation of law on
                death</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TSCNV</code> - Transfer subject to a charge
                (not for value or reverse premium)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TSCV</code> - Transfer subject to a charge for
                value</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TVR</code> - Transfer for value RTB/RTA</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">UNN</code> - Unilateral notice (UN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">UPT</code> - Upgrade class of title (UT1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VC</code> - Variation of charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VLAN</code> - Variation of lease - agreed
                notice (AN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VLAP</code> - Deed of variation of a lease -
                not increasing the term of or adding new land to the extent demised</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VLUN</code> - Variation of lease - unilateral
                notice (UN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VO</code> - Vesting order</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VOC</code> - Variation of covenants</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VOCA</code> - Variation of covenants - agreed
                notice (AN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VOCU</code> - Variation of covenants -
                unilateral notice (UN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VOE</code> - Variation of easements</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VOEA</code> - Variation of easements - agreed
                notice (AN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VOEU</code> - Variation of easements -
                unilateral notice (UN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">WCT</code> - Withdrawal of caution</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">WDR</code> - Withdraw a restriction (RX4)</li>
            </ul>
            ...
            <ul class="govuk-list govuk-list--bullet">
              ...
              <li><code style="color: #a71d5d; background-color: #f5f5f5">APLM</code> - Appointment of liquidator
                (members’ voluntary winding up)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">APR</code> - Apportionment of rent</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">ASSTTP</code> - Assent (Transfer of Part)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">C</code> - Charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CAG</code> - Cancellation of notice (not
                unilateral) (CN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CANI</code> - Cancellation of inhibition (RX3)
              ...
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CON</code> - Consolidation of charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">COP</code> - Charge of part</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CPVU</code> - Compulsory purchase (property
                value unknown)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CTD</code> - Commonhold transitional dealing
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">CUR</code> - Cancellation of notice of
              ...
              <li><code style="color: #a71d5d; background-color: #f5f5f5">STVC</code> - Statutory vestings charge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">STVL</code> - Statutory vestings land</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TNVTP</code> - Transfer (not for value or
                reverse premium) (Transfer of part)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TOSNVTP</code> - Transfer of share (not for
                value or reverse premium) (Transfer of part)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TOSTP</code> - Transfer of share for value
                (Transfer of part)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TPSTP</code> - Transfer under power of sale
                (Transfer of part)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TRC</code> - Termination of commonhold</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TSCNVTP</code> - Transfer subject to a charge
                (not for value or reverse premium) (Transfer of part)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TSCVTP</code> - Transfer subject to a charge
                for value (Transfer of part)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TTP</code> - Transfer for value (Transfer of
                part)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">TVRTP</code> - Transfer for value RTB/RTA
                (Transfer of part)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">UNN</code> - Unilateral notice (UN1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">UPT</code> - Upgrade class of title (UT1)</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">VC</code> - Variation of charge</li>
            ...
            <ul class="govuk-list govuk-list--bullet">
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">ADV1</code>
                - First notice of adverse possession
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">AGN</code>
                - Agreed notice (AN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">AUN</code>
                - Amendment of unilateral notice (UN3)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">BKR</code>
                - Bankruptcy restriction/Bankruptcy inhibition
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">C</code>
                - Charge
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CAG</code>
                - Cancellation of notice (not unilateral) (CN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CANI</code>
                - Cancellation of inhibition (RX3)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CANR</code>
                - Cancellation of restriction (RX3)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CANU</code>
                - Cancellation of unilateral notice (UN4)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CBKN</code>
                - Cancellation of bankruptcy notice
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CBKR</code>
                - Cancellation of bankruptcy restriction
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CCT</code>
                - Cancellation of a caution (CCD)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CH2</code>
                - Obligation to make further advances (CH2)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CH3</code>
                - Agreed maximum amount of security (CH3)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CHOA</code>
                - Charging order - Agreed notice (AN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CHOU</code>
                - Charging order - Unilateral notice (UN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CHR</code>
                - Cancellation of home rights (HR4)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CN</code>
                - Change of name
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CNC</code>
                - Change of name- chargee
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CNL</code>
                - Cancellation of an unregistered noted lease (CN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">COA</code>
                - Change of address for service
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">COAC</code>
                - Change of address for service - chargee
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">COP</code>
                - Charge of part
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">CUR</code>
                - Cancellation of notice of unregistered Rentcharge
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DCLV</code>
                - Disclaimer - notice
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DFL1</code>
                - New lease - other
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DFL3</code>
                - New lease - shared ownership
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DFL4</code>
                - New lease - right to buy or right to acquire
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DFT</code>
                - Defect in title s64(1) LRA 2002
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DIS</code>
                - Discharge of charge
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DJP</code>
                - Death of a joint proprietor
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DMR</code>
                - Disapplication of restriction (RX2)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DOG</code>
                - Deed of grant of easement
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DP</code>
                - Discharge of part
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DSP</code>
                - Death of a sole proprietor
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">DTL</code>
                - Discontinuous lease - timeshare
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">HR</code>
                - Notice of home rights (HR1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">LCBD</code>
                - Lease closure - by disclaimer
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">LCBN</code>
                - Lease closure - by notice
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">LCF</code>
                - Lease closure - forfeiture
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">LCMRE</code>
                - Lease closure - merger with reversionary estate
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">LCOE</code>
                - Lease closure - on enlargement
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">LCSD</code>
                - Lease closure - surrender by deed (not for value or reverse premium)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">LCSDM</code>
                - Lease closure - surrender by deed
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">LCSDMWT</code>
                - Lease closure - surrender by deed (together with transfer)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">LCSOL</code>
                - Lease closure - surrender by operation of law (not for value or reverse premium)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">MDR</code>
                - Modification of Restriction
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">NDC</code>
                - Notification of dissolution of company
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">NFR</code>
                - Noting of an affecting franchise
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">NOL</code>
                - Noting a lease
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">NPR</code>
                - Noting of a profit
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">NRT</code>
                - Notice of rentcharge
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">PC</code>
                - Postponement of charge
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">PER</code>
                - Personal covenants
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">PRO</code>
                - Provisions
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">RC</code>
                - Restrictive covenants - entry of
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">RFN</code>
                - Deed of rectification
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">RHR</code>
                - Renewal of home rights (HR2)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">RNT</code>
                - Overriding lease granted under s.19
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">ROCA</code>
                - Release of covenants - agreed notice (AN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">ROCC</code>
                - Release of covenants - cancellation (CN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">ROCU</code>
                - Release of covenants - unilateral notice (UN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">ROE</code>
                - Release of easements
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">RRD</code>
                - Removal of a right to determine
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">RUN</code>
                - Removal of unilateral notice (UN2)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">RXN</code>
                - Restriction (non-standard wording) (RX1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">RXS</code>
                - Restriction (standard wording) (RX1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">SBC</code>
                - Sub charge
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">SJT</code>
                - Severance of joint tenancy (SEV)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">UNN</code>
                - Unilateral notice (UN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">UPT</code>
                - Upgrade class of title (UT1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">VC</code>
                - Variation of charge
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">VLAN</code>
                - Variation of lease - agreed notice (AN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">VLAP</code>
                - Deed of variation of a lease - not increasing the term of or adding new land to the extent demised
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">VLUN</code>
                - Variation of lease - unilateral notice (UN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">VOC</code>
                - Variation of covenants
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">VOCA</code>
                - Variation of covenants - agreed notice (AN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">VOCU</code>
                - Variation of covenants - unilateral notice (UN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">VOE</code>
                - Variation of easements
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">VOEA</code>
                - Variation of easements - agreed notice (AN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">VOEU</code>
                - Variation of easements - unilateral notice (UN1)
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">WCT</code>
                - Withdrawal of caution
              </li>
              <li>
                <code style="color: #a71d5d; background-color: #f5f5f5">WDR</code>
            ...
            <p class="govuk-body">For a lease extension application, the <code
                style="color: #a71d5d; background-color: #f5f5f5">DFL5</code> (Dispositionary first lease extension of a
            ...
            <ul class="govuk-list govuk-list--bullet">
              ...
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DCLV</code> - Disclaimer - notice</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DFL1</code> - New lease - other</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DFL5</code> - Dispositionary first lease
              ...
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DP</code> - Discharge of part</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">DSP</code> - Death of a sole proprietor</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">EXR</code> - Extinguishment of rentcharge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">LCBD</code> - Lease closure - by disclaimer
              </li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">NRT</code> - Notice of rentcharge</li>
              <li><code style="color: #a71d5d; background-color: #f5f5f5">PRO</code> - Provisions</li>
            ...
            <p class="govuk-body">The only valid transaction type for the <code
                style="color: #a71d5d; background-color: #f5f5f5">REMOVE_JP1</code> application type is <code
                style="color: #a71d5d; background-color: #f5f5f5">JP1</code>. This must be the only transaction, and
              there must only be a single <code style="color: #a71d5d; background-color: #f5f5f5">JP1</code> transaction
              per application.</p>
          </div>
        </details>
        ...
        <p class="govuk-body">For certain transaction types, more detailed information is needed (via the <code
            style="color: #a71d5d; background-color: #f5f5f5">Transaction.details</code> field). This field can be one
          of several different types:</p>
        <ul class="govuk-list govuk-list--bullet">
          <li><code style="color: #a71d5d; background-color: #f5f5f5">Transfer</code></li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">Charge</code></li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">Discharge</code></li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">AmountDetails</code></li>
        </ul>
        ...
        <ul class="govuk-list govuk-list--bullet">
          <li><code style="color: #a71d5d; background-color: #f5f5f5">T</code> - Transfer for value</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TNV</code> - Transfer (not for value or reverse
            premium)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TOSNV</code> - Transfer of share (not for value or
            reverse premium)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TSCNV</code> - Transfer subject to a charge (not
        ...
        <ul class="govuk-list govuk-list--bullet">
          <li><code style="color: #a71d5d; background-color: #f5f5f5">DIS</code> - Discharge</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">DP</code> - Discharge of part</li>
        </ul>
        <p class="govuk-body"><code>AmountDetails</code></p>
        <ul class="govuk-list govuk-list--bullet">
          <li><code style="color: #a71d5d; background-color: #f5f5f5">ASTT</code> - Assent</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">ASTC</code> - Assent of charge</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">APT</code> - Appointment of new trustee</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">ASSTTP</code> - Assent (Transfer of part)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">CPVK</code> - Compulsory purchase (property value
            known)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">CPVU</code> - Compulsory purchase (property value
            unknown)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">DFL1</code> - New lease - other</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">DFL3</code> - New lease - shared ownership</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">DFL4</code> - New lease - right to buy or right to
            acquire</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">DFL5</code> - Dispositionary first lease extension
            of a term</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">DL</code> - Discontinuous lease - non-timeshare
          </li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">DTL</code> - Discontinuous lease - timeshare</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSD</code> - Lease closure - surrender by deed
            (not for value or reverse premium)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSDM</code> - Lease closure - surrender by deed
          </li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSDWT</code> - Lease closure - surrender by deed
            with a transfer (not for value or reverse premium)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSDMWT</code> - Lease closure - surrender by deed
            (together with transfer)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSOL</code> - Lease closure - surrender by
            operation of law (not for value or reverse premium)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">LCSOLM</code> - Lease closure - surrender by
            operation of law</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">RNT</code> - Overriding lease granted under s.19,
            Landlord & Tenant (Covenants) Act 1995</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TNVTP</code> - Transfer (not for value or reverse
            premium) (Transfer of part)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TOC</code> - Transfer of charge</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TOSNVTP</code> - Transfer of share (not for value
          ...
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TPSTP</code> - Transfer under power of sale
            (Transfer of part)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TRM</code> - Transfer by operation of law on death
          </li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TSCNVTP</code> - Transfer subject to a charge (not
            for value or reverse premium) (Transfer of part)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TSCTP</code> - Transfer subject to a charge for
            value (Transfer of part)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TTP</code> - Transfer for value (Transfer of part)
          </li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TVR</code> - Transfer for value RTB/RTA </li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TVRTP</code> - Transfer for value RTB/RTA
            (Transfer of part)</li>
        ...
        <p class="govuk-body">Titles included as part of submission have a <code
            style="color: #a71d5d; background-color: #f5f5f5">type</code> field that informs HMLR how to process the
        ...
        <p class="govuk-body">Only title types of <code
            style="color: #a71d5d; background-color: #f5f5f5">REGISTER_TITLE</code> are supported.</p>
        ...
        <ul class="govuk-list govuk-list--bullet">
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TRANSFEROR_TITLE</code> - titles related to the
            transferor(s) on the application</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">ADDITIONAL_TITLE</code> - any other titles on the
            application</li>
        </ul>
        <h3 class="govuk-heading-s"><code>DISPOSITIONARY_FIRST_LEASE</code> application types</h3>
        <p class="govuk-body">The following title types are supported:</p>
        <ul class="govuk-list govuk-list--bullet">
          <li><code style="color: #a71d5d; background-color: #f5f5f5">LANDLORD_TITLES</code> - titles related to the
        ...
        <p class="govuk-body">For a lease extension application (where the transaction type is <code
            style="color: #a71d5d; background-color: #f5f5f5">DFL5</code> Dispositionary first lease extension of a
          term) a single title with type <code style="color: #a71d5d; background-color: #f5f5f5">TENANT_TITLE</code>
        ...
        <p class="govuk-body">To trigger this functionality, the <code
            style="color: #a71d5d; background-color: #f5f5f5">register_action</code> field on the <code
            style="color: #a71d5d; background-color: #f5f5f5">party</code> object can be used. This field has two
          options:</p>
        <ul class="govuk-list govuk-list--bullet">
          <li><code style="color: #a71d5d; background-color: #f5f5f5">AMEND</code> - the party information is different
            to the currently held register information</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">REMOVE</code> - The party on the register should
            be removed</li>
        </ul>
    ...
    "address_for_service_option": "PROVIDED_ADDRESS"
        ...
        <p class="govuk-body">During application submission, several validation rules will run against the data provided
          to ensure it is valid. A number of these rules run synchronously before an <code
            style="color: #a71d5d; background-color: #f5f5f5">application_request_id</code> is returned and they are
          documented in the schema documentation. Other rules run asynchronously, after the <code
            style="color: #a71d5d; background-color: #f5f5f5">application_request_id</code> has been returned.</p>
        ...
        <p class="govuk-body">If an application fails validation, there may be legitimate reasons why you might want
          HMLR to ignore specific rules. In this case, we provide a <code
            style="color: #a71d5d; background-color: #f5f5f5">bypass_validation</code> array that can be used to ignore
          validation rules for specific objects, as defined by the <code
            style="color: #a71d5d; background-color: #f5f5f5">pointer</code>.</p>
        ...
        <ul class="govuk-list govuk-list--bullet">
          <li><code style="color: #a71d5d; background-color: #f5f5f5">validation_type</code> - the type of validation
            rule you want to bypass. This is returned in the <code
              style="color: #a71d5d; background-color: #f5f5f5">type</code> field from any validation erro</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">validation_pointer</code> - the location of the
            object in the payload structure. This is returned in the <code
              style="color: #a71d5d; background-color: #f5f5f5">pointer</code>field from some validation errors</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">reason</code> - the specific reason the bypass was
            required. Must be one of:</li>
          <ul class="govuk-list govuk-list--bullet">
            <li><code style="color: #a71d5d; background-color: #f5f5f5">DISAGREE_WITH_REGISTER</code> - the validation
              rule is incorrect because the data on the register is incorrect</li>
            <li><code style="color: #a71d5d; background-color: #f5f5f5">HMLR_DATA_INCORRECT_OR_OUTDATED</code> - there
              is missing, outdated or incorrect data in a comparison database</li>
            <li><code style="color: #a71d5d; background-color: #f5f5f5">EXCEPTION_NOT_COVERED_BY_BUSINESS_RULES</code> -
              the application is valid. An exception should apply but is not covered by current business rules</li>
          </ul>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">comment</code> - a user inputted description of
        ...
        <p class="govuk-body">Bypassing validation can only be done for specific rules, and each rule is only permitted
          to have specific reasons for bypassing the validation. Information about which validation types support
          bypassing and which reasons are valid for those types are defined below:-color:</p>
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">all-proprietors-matched-to-borrowers</code></td>
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">DISAGREE_WITH_REGISTER</code><br><code
                  style="color: #a71d5d; background-color: #f5f5f5">EXCEPTION_NOT_COVERED_BY_BUSINESS_RULES</code></td>
            </tr>
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">lender-name-matches-records</code></td>
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">HMLR_DATA_INCORRECT_OR_OUTDATED</code></td>
            </tr>
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">mdref-on-record</code></td>
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">HMLR_DATA_INCORRECT_OR_OUTDATED</code></td>
            </tr>
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">all-proprietors-matched-to-transferors</code></td>
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">DISAGREE_WITH_REGISTER</code><br><code
                  style="color: #a71d5d; background-color: #f5f5f5">EXCEPTION_NOT_COVERED_BY_BUSINESS_RULES</code></td>
            </tr>
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">transferee-has-a-valid-address</code></td>
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">HMLR_DATA_INCORRECT_OR_OUTDATED</code></td>
            </tr>
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">all-mandatory-documents-provided</code></td>
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">EXCEPTION_NOT_COVERED_BY_BUSINESS_RULES</code></td>
            </tr>
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">identity-evidence-has-type</code></td>
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">EXCEPTION_NOT_COVERED_BY_BUSINESS_RULES</code></td>
            </tr>
          </tbody>
...
<code class="language-json" style="background-color: #f3f2f1">
  {
      "data": {
        ...
        <p class="govuk-body">Applicant name must be present using the English alphabet. Applicant must not have a party
          type of <code style="color: #a71d5d; background-color: #f5f5f5">UNKNOWN</code>.</p>
        <p class="govuk-body">Error types for this validator will be provided at a later date.</p>
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">all-proprietors-matched-to-borrowers</code></td>
              <td class="govuk-table__cell govuk-table__cell">Can apply to one of the following:<ul>
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">transaction-has-valid-borrower</code></td>
              <td class="govuk-table__cell govuk-table__cell">Subcharge transactions or charge transactions
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">charge-must-have-non-negative-value</code></td>
              <td class="govuk-table__cell govuk-table__cell">Charge value must be non-negative</td>
            </tr>
          </tbody>
        </table>
        ...
        <p class="govuk-body">Checks the <code
            style="color: #a71d5d; background-color: #f5f5f5">conveyancers_certificate</code> field is set for any
          document of type <code style="color: #a71d5d; background-color: #f5f5f5">CERT_REG_CH</code>.</p>
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">conveyancers-certificate-provided</code></td>
              <td class="govuk-table__cell govuk-table__cell">Conveyancers certificate was not provided for Certificate
        ...
        <p class="govuk-body">For option three, details must be provided. For option four, HMLR form JO must be provided
          as an attachment.</p>
        <table class="govuk-table">
          <caption class="govuk-table__caption govuk-table__caption--s">Declaration of trust validation error types
          </caption>
          <thead class="govuk-table__head">
            <tr class="govuk-table__row">
              <th scope="col" class="govuk-table__header">Error type</th>
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">declaration-of-trust</code></td>
              <td class="govuk-table__cell govuk-table__cell"> The declaration of trust option must be provided for the
                application</td>
            </tr>
          </tbody>
        </table>
        ...
        <p class="govuk-body">When <code
            style="color: #a71d5d; background-color: #f5f5f5">disclosable_overriding_interests</code> is set to <code
            style="color: #a71d5d; background-color: #f5f5f5">true</code> on any transaction, a <code
            style="color: #a71d5d; background-color: #f5f5f5">FORM_DI</code> document must be provided with the
          application.</p>
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">di-form-required</code></td>
              <td class="govuk-table__cell govuk-table__cell">A Disclosable Overriding Interests (DI) Form is required
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">identity-evidence-has-type</code></td>
              <td class="govuk-table__cell govuk-table__cell">One of the following options must be provided:
                <ol class="govuk-list govuk-list--number">
                  <li>Evidence</li>
                  <li>Verified</li>
                  <li>Not required</li>
            ...
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">required-identity-evidence-provided</code></td>
              <td class="govuk-table__cell govuk-table__cell">An HMLR identity form must be provided for each
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">charge-has-valid-lender</code></td>
              <td class="govuk-table__cell govuk-table__cell">The lender has an invalid address for service when an MD
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">unique-lender</code></td>
              <td class="govuk-table__cell govuk-table__cell">Each charge should only have one lender</td>
            </tr>
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">lender-name-matches-records</code></td>
              <td class="govuk-table__cell govuk-table__cell">The lender name provided in the application data must
                match that recorded for the lender in our MD reference database</td>
            </tr>
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">no-duplicate-lender-refs-on-charge</code></td>
              <td class="govuk-table__cell govuk-table__cell">Lender references must be unique</td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">charge-has-valid-lender</code></td>
              <td class="govuk-table__cell govuk-table__cell">There are no lenders on the charge application</td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">all-mandatory-documents-provided</code></td>
              <td class="govuk-table__cell govuk-table__cell">Each transaction must have the mandatory deed or document
                provided</td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">mdref-on-record</code></td>
              <td class="govuk-table__cell govuk-table__cell">The MD reference supplied cannot be found in our database
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">address-for-service-option-is-valid</code></td>
              <td class="govuk-table__cell govuk-table__cell">The address for service option provided for the party is
                invalid</td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">submission-warning-understood</code></td>
              <td class="govuk-table__cell govuk-table__cell">A legal declaration is made when submitting an application
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">request-has-title-number</code></td>
              <td class="govuk-table__cell govuk-table__cell">At least one title number must be provided (including
            ...
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">request-has-title-number</code></td>
              <td class="govuk-table__cell govuk-table__cell">Title number not matched to HMLR systems</td>
            </tr>
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">title-must-be-valid</code></td>
              <td class="govuk-table__cell govuk-table__cell">Can apply to one of the following:
                <ul class="govuk-list govuk-list--bullet">
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">title-scope-is-valid</code></td>
              <td class="govuk-table__cell govuk-table__cell">Can apply to one of the following:
                <ul class="govuk-list govuk-list--bullet">
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">OCV_L1A_005</code></td>
              <td class="govuk-table__cell govuk-table__cell">Non unique transaction priorities were found</td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">transfer-date-not-in-future</code></td>
              <td class="govuk-table__cell govuk-table__cell">The date of the transfer must not be in the future</td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">transfer-has-transferee</code></td>
              <td class="govuk-table__cell govuk-table__cell">A transfer involves a change of proprietor(s). If making
                an application for a transfer, there must be at least one transferee</td>
            </tr>
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">transferee-has-valid-address</code></td>
              <td class="govuk-table__cell govuk-table__cell">At least one postal address must be provided in the
                application</td>
            </tr>
          </tbody>
        </table>
        ...
        <p class="govuk-body">For a transfer, there must be at least one transferor name without the register action of
          <code style="color: #a71d5d; background-color: #f5f5f5">REMOVE</code>.</p>
        <table class="govuk-table">
          ...
          <tbody class="govuk-table__body">
            <tr class="govuk-table__row">
              <td class="govuk-table__cell govuk-table__cell"><code
                  style="color: #a71d5d; background-color: #f5f5f5">transfer-has-transferors</code></td>
              <td class="govuk-table__cell govuk-table__cell">A transfer involves a change of proprietor(s). If making
        ...
        <p class="govuk-body">Value bands specify the approximate value of a property, or the equity being transferred,
          where the full value is not known. The value band fields can be found on the <code
            style="color: #a71d5d; background-color: #f5f5f5">Transfer</code> and <code
            style="color: #a71d5d; background-color: #f5f5f5">AmountDetails</code> objects in the API specification.</p>
        <p class="govuk-body">The valid value bands are as follows (in pounds):</p>
        <ul class="govuk-list govuk-list--bullet">
          <li><code style="color: #a71d5d; background-color: #f5f5f5">lower_band</code>: 0, <code
              style="color: #a71d5d; background-color: #f5f5f5">upper_band</code>: 100,000</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">lower_band</code>: 100,001, <code
              style="color: #a71d5d; background-color: #f5f5f5">upper_band</code>: 200,000</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">lower_band</code>: 200,001, <code
              style="color: #a71d5d; background-color: #f5f5f5">upper_band</code>: 500,000</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">lower_band</code>: 500,001, <code
              style="color: #a71d5d; background-color: #f5f5f5">upper_band</code>: 1,000,000</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">lower_band</code>: 1,000,001, <code
              style="color: #a71d5d; background-color: #f5f5f5">upper_band</code>: <code
              style="color: #a71d5d; background-color: #f5f5f5">null</code></li>
        </ul>
        <p class="govuk-body">Value bands are only applicable to the following transaction types:</p>
        <ul class="govuk-list govuk-list--bullet">
          <li><code style="color: #a71d5d; background-color: #f5f5f5">APT</code> - Appointment of new trustee</li>
          ...
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TOSNV</code> - Transfer of share (not for value or
            reverse premium)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TSCNVTP</code> - Transfer of share (not for value
            or reverse premium) (Transfer of part)</li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TRM</code> - Transfer by operation of law on death
          </li>
          <li><code style="color: #a71d5d; background-color: #f5f5f5">TSCNV</code> - Transfer subject to a charge (not
        ...
        <ul class="govuk-list govuk-list--bullet">
          <li>Both <code style="color: #a71d5d; background-color: #f5f5f5">value</code> (i.e. value of equity being
            transferred) and <code style="color: #a71d5d; background-color: #f5f5f5">full_value_of_property</code> must
            be either value bands, or exact values</li>
          <li>The <code style="color: #a71d5d; background-color: #f5f5f5">full_value_of_property_band</code> must be
            greater than or equal to the <code style="color: #a71d5d; background-color: #f5f5f5">value_band</code> (i.e.
