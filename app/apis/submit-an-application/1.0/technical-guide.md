...
{{ govukTable({
  ...
  rows: [
    ...
    [{ text: "ADV1NT2" }, { text: "Second notice of adverse possession" }],
    [{ text: "ADV1S12" }, { text: "Adverse possession (under schedule 12)" }],
    ...
    [{ text: "C" }, { text: "Charge" }],
    [{ text: "CADV" }, { text: "Cancellation of adverse possession" }],
    ...
    [{ text: "DFL6" }, { text: "New lease - taking effect more than three months from the date of grant" }],
    ...
    [{ text: "NAOA" }, { text: "Application to note appointment of an administrator" }],
    ...
    [{ text: "RADV" }, { text: "Removal of Adverse Possession entry (proprietorship protective entry)" }],
    ...
    [{ text: "RORBAP" }, { text: "Registering Official receiver in bankruptcy as proprietor" }],
    ...
    [{ text: "RTBAP" }, { text: "Registering Trustee in bankruptcy as a proprietor" }],
...
{{ govukTable({
  ...
  rows: [
    ...
    [{ text: "CC" }, { text: "CC Entry of a note of Consolidation of charges" }],
    ...
    [{ text: "DS1" }, { text: "DS1 Cancellation of entries for lenders" }],
    ...
    [{ text: "DS3_SHORT" }, { text: "DS3 Release of part of the land for lenders" }],
    ...
    [{ text: "TR4" }, { text: "TR4 Transfer a charge or a portfolio of charges" }],
...
{{ govukTable({
  ...
  rows: [
    ...
    [{ text: "" }, { text: "COR_CERT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "POA" }, { text: "Suggested" }],
    [{ text: "T" }, { text: "TR1 or TR5" }, { text: "Compulsory" }],
    [{ text: "" }, { text: "COMP_DOC" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONSENT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONV_CERT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "DEATH_CERT" }, { text: "Suggested" }],
    ...
    [{ text: "TNV" }, { text: "TR1 or TR5" }, { text: "Compulsory" }],
    [{ text: "" }, { text: "COMP_DOC" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONSENT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONV_CERT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "FORM_JO" }, { text: "Suggested" }],
    ...
    [{ text: "" }, { text: "CIVIL_CERT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "PROBATE" }, { text: "Suggested" }],
    [{ text: "TNVTP" }, { text: "TP1 or TR5" }, { text: "Compulsory" }],
    [{ text: "" }, { text: "COMP_DOC" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONSENT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONV_CERT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "PLAN" }, { text: "Suggested" }],
    ...
    [{ text: "" }, { text: "CONV_CERT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "PLAN" }, { text: "Suggested" }],
    [{ text: "TSCTP" }, { text: "TP1 or TR5" }, { text: "Compulsory" }],
    [{ text: "" }, { text: "CONSENT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONV_CERT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "PLAN" }, { text: "Suggested" }],
    [{ text: "TSCV" }, { text: "TR1 or TR5" }, { text: "Compulsory" }],
    [{ text: "" }, { text: "COMP_DOC" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONSENT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONV_CERT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "FORM_JO" }, { text: "Suggested" }],
    ...
    [{ text: "" }, { text: "CIVIL_CERT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "PROBATE" }, { text: "Suggested" }],
    [{ text: "TTP" }, { text: "TP1 or TR5" }, { text: "Compulsory" }],
    [{ text: "" }, { text: "COMP_DOC" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONSENT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "CONV_CERT" }, { text: "Suggested" }],
    [{ text: "" }, { text: "PLAN" }, { text: "Suggested" }],
...
<ul class="govuk-list govuk-list--bullet">
  ...
  <li><code class="app-code app-code--inline">AML</code> - Amalgamation</li>
